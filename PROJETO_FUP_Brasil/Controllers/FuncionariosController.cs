...
namespace PROJETO_FUP_Brasil.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FuncionarioId,NomeFuncionario,Rg,Cpf,Datanascimento,Genero,SalarioFuncionario")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FuncionarioId,NomeFuncionario,Rg,Cpf,Datanascimento,Genero,SalarioFuncionario")] Funcionario funcionario)
        {
